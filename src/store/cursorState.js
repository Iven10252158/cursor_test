  ...
  setWsRes (state, msg) {
    ...
    switch (state.cursor_available.trim()) {
      case 'true':
        ...
        // console.log('true', state.cursor_available)
        // console.log('true', typeof state.cursor_available)
        break
      case 'false':
        state.cursor_available = false
        // state.cursor_color_red = true
        // console.log('false', state.cursor_available)
        // console.log('false', typeof state.cursor_available)
        break
